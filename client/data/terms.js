const terms = {
  ...
  PER: {
    ...
    example:
      "이 종목의 PER이 업종 평균보다 낮아 저평가 구간으로 평가받고 있다.",
    category: "주식",
  },
  환율: {
    word: "환율",
    ...
    example:
      "원/달러 환율이 상승하면 수출 기업의 원화 환산 수익이 증가할 수 있다.",
    category: "환율",
  },
  외환보유액: {
    word: "외환보유액",
  ...
  LTV: {
    word: "LTV",
    meaning: "담보인정비율(Loan-To-Value), 담보 가치 대비 대출 가능 금액의 비율",
  ...
  전세: {
    word: "전세",
    meaning: "일정 보증금을 맡기고 일정 기간 주택을 임차하는 한국 특유의 주거 형태",
  ...
  채권금리: {
    word: "채권금리",
    meaning:
      "채권에서 발생하는 이자 수익률로, 채권 가격과 반대 방향으로 움직임",
  ...
  실업률: {
    ...
    example:
      "실업률이 3.2%로 낮아지며 노동 시장의 안정세가 이어지고 있다.",
    category: "경제지표",
  },
};
